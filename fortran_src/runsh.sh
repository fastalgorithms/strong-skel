...
gfortran -O3 -march=native -fPIC -fopenmp -c ellipsoid_routs.f90 -o ellipsoid_routs.o -L/usr/local/lib -lfmm3d -lfmm3dbie_matlab
...
/Applications/MATLAB_R2021a.app/bin/mex -v fmm3dbierouts.c helmquadcorr.o read_plane_geom.o ellipsoid_routs.o -largeArrayDims -DMWF77_UNDERSCORE1 -D_OPENMP -L/usr/local/lib/gcc/12 -output fmm3dbierouts -L/usr/local/lib -lfmm3d -lfmm3dbie_matlab -lgomp -lstdc++ -lm -ldl -lgfortran
