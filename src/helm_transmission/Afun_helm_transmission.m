function A = Afun_helm_transmission(i, j, x, z_k, z_k0, nu, area, P, S, deps, deps0)
...
M1 = spget_quadcorr(i, j, P, S{2});
idx1 = abs(M1) ~= 0;

M2 = spget_quadcorr(i, j, P, S{1});
idx2 = abs(M2) ~= 0;

M3 = -spget_quadcorr(i, j, P, S{4});
idx3 = abs(M3) ~= 0;

M4 = -spget_quadcorr(i, j, P, S{3});
idx4 = abs(M4) ~= 0;
